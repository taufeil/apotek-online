...
<body>
    ...
    <div class="left-sidebar-pro">
        <nav id="sidebar" class="">
            <div class="sidebar-header">
                <a href="index.html"><img class="main-logo" src="be/img/logo/logo.png" alt="" /></a>
                <strong><a href="index.html"><img src="be/img/logo/logosn.png" alt="" /></a></strong>
            </div>
                                            ...
                                            <ul class="nav navbar-nav mai-top-nav header-right-menu">
                                                    ...
                                                    <div role="menu" class="author-message-top dropdown-menu animated zoomIn">
                                                        ...
                                                        <ul class="message-menu">
                                                            <li>
                                                                <a href="#">
                                                                    <div class="message-img">
                                                                        <img src="be/img/contact/1.jpg" alt="">
                                                                    </div>
                                                            ...
                                                            <li>
                                                                <a href="#">
                                                                    <div class="message-img">
                                                                        <img src="be/img/contact/4.jpg" alt="">
                                                                    </div>
                                                                    <div class="message-content">
                                                                        <span class="message-date">16 Sept</span>
                                                                        <h2>Sulaiman din</h2>
                                                            ...
                                                            <li>
                                                                <a href="#">
                                                                    <div class="message-img">
                                                                        <img src="be/img/contact/3.jpg" alt="">
                                                                    </div>
                                                                    <div class="message-content">
                                                                        <span class="message-date">16 Sept</span>
                                                                        <h2>Victor Jara</h2>
                                                            ...
                                                            <li>
                                                                <a href="#">
                                                                    <div class="message-img">
                                                                        <img src="be/img/contact/2.jpg" alt="">
                                                                    </div>
                                                                    <div class="message-content">
                                                                        <span class="message-date">16 Sept</span>
                                                                        <h2>Victor Jara</h2>
                                                ...
                                                <li class="nav-item">
                                                    <a href="#" data-toggle="dropdown" role="button" aria-expanded="false" class="nav-link dropdown-toggle">
															<img src="be/img/product/pro4.jpg" alt="" />
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
                        <div class="single-review-st-item res-mg-t-30 table-mg-t-pro-n">
                            ...
                            <div class="single-review-st-text">
                                <img src="be/img/notification/1.jpg" alt="">
                            ...
                            <div class="single-review-st-text">
                                <img src="be/img/notification/2.jpg" alt="">
                                <div class="review-ctn-hf">
                                    <h3>Garbease sha</h3>
                                    <p>Awesome Pro</p>
                                </div>
                            ...
                            <div class="single-review-st-text">
                                <img src="be/img/notification/3.jpg" alt="">
                                <div class="review-ctn-hf">
                                    <h3>Gobetro pro</h3>
                                    <p>Great Website</p>
                                </div>
                            ...
                            <div class="single-review-st-text">
                                <img src="be/img/notification/4.jpg" alt="">
                                <div class="review-ctn-hf">
                                    <h3>Siam Graves</h3>
                                    <p>That's Good</p>
                                </div>
                            ...
                            <div class="single-review-st-text">
                                <img src="be/img/notification/5.jpg" alt="">
                                <div class="review-ctn-hf">
                                    <h3>Sarah Graves</h3>
                                    <p>Highly recommend</p>
                                </div>
                            ...
                            <div class="single-review-st-text">
                                <img src="be/img/notification/6.jpg" alt="">
                                <div class="review-ctn-hf">
                                    <h3>Julsha Grav</h3>
                                    <p>Sei Hoise bro</p>
                                </div>
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                        <div class="single-product-item res-mg-t-30 table-mg-t-pro-n tb-sm-res-d-n dk-res-t-d-n">
                            <div class="single-product-image">
                                <a href="#"><img src="be/img/product/book-4.jpg" alt=""></a>
                            </div>
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                        <div class="courses-inner res-mg-t-30 table-mg-t-pro-n tb-sm-res-d-n dk-res-t-d-n">
                            <div class="courses-title">
                                <a href="#"><img src="be/img/courses/1.jpg" alt="" /></a>
    ...
    <!-- counterup JS
		============================================ -->
    <script src="be/js/counterup/jquery.counterup.min.js"></script>
    <script src="be/js/counterup/waypoints.min.js"></script>
    <script src="be/js/counterup/counterup-active.js"></script>
    <!-- mCustomScrollbar JS
		============================================ -->
    ...
    <!-- morrisjs JS
		============================================ -->
    <script src="be/js/morrisjs/raphael-min.js"></script>
    <script src="be/js/morrisjs/morris.js"></script>
    <script src="be/js/morrisjs/morris-active.js"></script>
    <!-- morrisjs JS
		============================================ -->
    <script src="be/js/sparkline/jquery.sparkline.min.js"></script>
    <script src="be/js/sparkline/jquery.charts-sparkline.js"></script>
    <script src="be/js/sparkline/sparkline-active.js"></script>
    <!-- calendar JS
		============================================ -->
    ...
    <!-- tawk chat JS
		============================================ -->
    <script src="be/js/tawk-chat.js"></script>
</body>
